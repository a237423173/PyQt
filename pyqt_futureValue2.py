...
class MyWidget(QtWidgets.QWidget):
    ...
    def ui(self):
        ...
        self.label_5.setGeometry(50,50+SEP*10,300,50)
        self.label_5.setText('最終金額')
    ...
    def count(self):
        ...
        self.futureValue = self.money*(1+self.rate/100)**self.years + self.save*((self.rate/100+1)**self.years-1)/self.rate*100
        self.FV = str(int(self.futureValue))
        self.label_5.setText("新臺幣" + self.FV + "元")
